...
const SoundButton = ({ children }) => {
  ...
  return (
    ...
    >
      <div className="group relative h-full overflow-hidden overflow-x-hidden rounded-md bg-neutral-950 px-8 py-2 text-neutral-50">
        <span className="relative z-10 text-base  rounded-md">{children}</span>
