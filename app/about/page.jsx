  ...
  return (
    <section className='w-full'>
      <div className='w-full border-b border-neutral-500'>
        <Image src='/profile-pic2.jpg' width={1024} height={1024} alt="Anurag's profile picture" className='w-full h-auto' />
      </div>
      <div className='space-y-10 p-8 mt-8 w-full leading-7 text-black dark:text-slate-300 text-lg'>
        <div className='space-y-10'>
          <div className='space-y-6 text-lg max-w-3xl'>
            <h1 className='text-3xl font-semibold text-black dark:text-white'>Hello, I'm Anurag</h1>
            <p>Over the past two years as a developer, I've built web-startups and co-founded Zlock Technologies Pvt Ltd. My journey has equipped me with a diverse set of skills.</p>
            <p>I'm deeply passionate about using technology to address real-world challenges, dedicated to developing user-friendly, scalable applications that cater to the needs of users and businesses.</p>
            <p>My experience has sharpened my ability to innovate and adapt in dynamic environments, propelling solutions that deliver tangible results.</p>
          </div>
          <div className='space-y-6 text-black dark:text-slate-200'>
            <h2 className='text-3xl  font-semibold text-black dark:text-white border-b pb-2'>Skills</h2>
          ...
          <div className='space-y-6 text-black dark:text-slate-200'>
            <h2 className='text-3xl w-fit font-semibold text-black dark:text-white border-b pb-2'>Education</h2>
            <div className='space-y-4'>
              <EducationItem degree='Bachelor of Engineering - Electronics and Communication' institution='Ramaiah Institute of Technology' period='2019-2023' />
              <EducationItem degree='Pre University - PCMS' institution='Expert PU College' period='2017-2019' />
            </div>
          </div>
        </div>
