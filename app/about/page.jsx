    ...
    <section>
      <div className="w-full border-b border-neutral-500">
        <Image
          ...
          quality={100}
          placeholder="blur"
          blurDataURL="UOEfZ=s+%#bbyZWEWFoz$gfhWBaxJ:oLsSf6"
        />
      </div>
...
const EducationItem = ({ degree, institution, period }) => (
  <div className="flex flex-col space-y-1">
    ...
    <p className="cursor-pointer group flex items-center w-fit ">
      {institution}
      <ArrowRightIcon className="opacity-0 group-hover:opacity-100 transition-all group-hover:translate-x-2 duration-200 w-5 " />{" "}
    </p>
